...
export const getCollaborateurs = createAsyncThunk(
  "gestion/getCollaborateurs",
  async () => {
    try {
...
export const getDetailsCollabo = createAsyncThunk(
  "gestion/getDetailsCollabo",
  async (item) => {
    try {
      let response = {};
      ...
      let InvoicesByCollabo =
        InvoicesCollabo?.data?.filter(
          (inv) => inv.header.fen_ent_fk == item.ent_id
        ) || [];
...
export const addNewCollaborateur = createAsyncThunk(
  "gestion/addNewCollaborateur",
  async (collabo) => {
    try {
...
export const deleteCollaborateurs = createAsyncThunk(
  "gestion/deleteCollaborateur",
  async (collabo) => {
    try {
...
export const onAddNewClientCompta = createAsyncThunk(
  "gestion/onAddNewClientCompta",
  async (collabo) => {
    try {
...
export const handleConstantes = createAsyncThunk(
  "gestion/handleConstantes",
  async (constantes) => {
    try {
      let arrayResponse = [];
...
export const getEntityPeriodCount = createAsyncThunk(
  "gestion/getEntityPeriodCount",
  async (data) => {
    try {
      ...
      toast.error(
        "Une erreur s'est produite sur la récupération des fournisseurs",
        { autoClose: 3000 }
      );
      return error;
    }
...
export const getAlert = createAsyncThunk("gestion/getAlert", async () => {
  try {
    ...
    console.log("thunk catch", error);
    toast.error(
      "Une erreur s'est produite lors de la récupération des rappels",
      { autoClose: 3000 }
    );
    return error;
  }
...
export const deleteAlert = createAsyncThunk(
  ...
  async (id) => {
    try {
      ...
      console.log("thunk catch", error);
      toast.error(
        "Une erreur s'est produite lors de la suppression du rappels",
        { autoClose: 3000 }
      );
      return error;
    }
