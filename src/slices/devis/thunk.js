...
export const addNewDevis = createAsyncThunk(
  "devis/addNewDevis",
  async (Devis) => {
    try {
...
export const createPdfDevis = createAsyncThunk(
  "devis/createPdfDevis",
  async (devis) => {
    try {
...
export const getDevisForEdit = createAsyncThunk(
  "devis/getDevisForEdit",
  async (id) => {
    try {
...
export const getDevisWidgets = createAsyncThunk(
  "devis/getDevisWidgets",
  async () => {
    try {
...
export const SendDevisByEmail = createAsyncThunk(
  "devis/SendDevisByEmail",
  async (id) => {
    try {
...
export const getEtatDevis = createAsyncThunk(
  "devis/getEtatDevis",
  async (id) => {
    try {
      ...
      toast.error(
        "Une erreur s'est produite sur la lecture de l'état d'un devis",
        { autoClose: 3000 }
      );
      return error;
    }
...
export const getDevisPeriodCount = createAsyncThunk(
  "devis/getDevisPeriodCount",
  async (data) => {
    try {
...
export const getDevisByMonth = createAsyncThunk(
  "devis/getDevisByMonth",
  async (data) => {
    try {
