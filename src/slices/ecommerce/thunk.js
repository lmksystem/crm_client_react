...
export const getProducts = createAsyncThunk("gestion/getProducts", async () => {
  try {
...
export const getOrders = createAsyncThunk("gestion/getOrders", async () => {
  try {
...
export const getSellers = createAsyncThunk("gestion/getSellers", async () => {
  try {
...
export const getCustomers = createAsyncThunk("gestion/getCustomers", async (params, { rejectWithValue }) => {
  try {
...
export const deleteProducts = createAsyncThunk("gestion/deleteProducts", async (product) => {
  try {
...
export const updateOrder = createAsyncThunk("gestion/updateOrder", async (order) => {
  try {
...
export const addNewProduct = createAsyncThunk("gestion/addNewProduct", async (product) => {
  try {
...
export const updateProduct = createAsyncThunk("gestion/updateProduct", async (product) => {
  try {
...
export const deleteOrder = createAsyncThunk("gestion/deleteOrder", async (order) => {
  try {
...
export const addNewOrder = createAsyncThunk("gestion/addNewOrder", async (order) => {
  try {
...
export const updateCustomer = createAsyncThunk("gestion/updateCustomer", async (customer) => {
  try {
...
export const deleteCustomer = createAsyncThunk("gestion/deleteCustomer", async (customer) => {
  try {
...
export const addNewCustomer = createAsyncThunk("gestion/addNewCustomer", async (customer) => {
  try {
