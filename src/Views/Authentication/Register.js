...
// action
import { registerUser, apiError, resetRegisterFlag, logoutUser } from "../../slices/thunks";
                      ...
                      <Form
                        ...
                        <div className="mb-4">
                          <p className="mb-0 fs-12 text-muted fst-italic">
                            By registering you agree to the Coutanto
                            <Link
                              to="#"
                        ...
                        <div className="mt-4 text-center">
                          ...
                          <div>
                            <button
                              type="button"
                              className="btn btn-secondary btn-icon waves-effect waves-light">
