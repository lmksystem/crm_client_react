...
const ResetPassword = (props) => {
  ...
  const validation = useFormik({
    ...
    onSubmit: (values) => {
      axios
        .post(`/v1/user/reset-password/${token}`, { newPassword: values.newpassword })
        .then((res) => {
          ...
          <Row className="justify-content-center">
            <Col
                      ...
                      <Row>
                        <Col
                          ...
                          <div className="position-relative auth-pass-inputgroup mb-3">
                            ...
                            />
                            {validation.touched.newpassword && validation.errors.newpassword ? <FormFeedback type="invalid">{validation.errors.newpassword}</FormFeedback> : null}
                            <button
                        ...
                        <Col
                          ...
                          <div className="position-relative auth-pass-inputgroup mb-3">
                            <Input
                              ...
                              onChange={validation.handleChange}
                              onBlur={validation.handleBlur}
                              invalid={validation.touched.passwordConfirmation && validation.errors.passwordConfirmation ? true : false}
                            />
                            {validation.touched.passwordConfirmation && validation.errors.passwordConfirmation ? <FormFeedback type="invalid">{validation.errors.passwordConfirmation}</FormFeedback> : null}
                            <button
                              className="btn btn-link position-absolute end-0 top-0 text-decoration-none text-muted"
                              type="button"
                              id="password-addon"
              ...
              <div className="mt-4 text-center">
                <p className="mb-0">
                  Je me rappel de mon mot de passe...{" "}
                  <Link
                    to="/login"
