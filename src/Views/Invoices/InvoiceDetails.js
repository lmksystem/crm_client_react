                      ...
                      <Row>
                        ...
                        <Col lg={4} className="flex-shrink-0 mt-lg-0 mt-3">
                          ...
                          <h6>
                            ...
                            <span id="email">
                              {invoice.contact.fco_address},{" "}
                              {invoice.contact.fco_city}
                            </span>
                          </h6>
                          <h6>
                            <span className="text-muted fw-normal">
                    ...
                    <Row className="g-3">
                      ...
                      >
                        ...
                        <p
                          ...
                          id="billing-address-line-1"
                        >
                          {invoice.contact.fco_cus_cp},{" "}
                          {invoice.contact.fco_cus_city}
                        </p>
                        <p className="text-muted mb-1">
                          <span>Téléphone: </span>
                          <span id="billing-phone-no">
                            {invoice.contact.fco_cus_phone}
                          </span>
                        </p>
                        <p className="text-muted mb-0">
                          <span>Email: </span>
                          <span id="billing-tax-no">
                            {invoice.contact.fco_cus_email}
                          </span>{" "}
                        </p>
                      </Col>
                    </Row>
                  ...
                  <CardBody className="border-bottom border-bottom-dashed p-4">
                    <Row className="g-3">
                      ...
                      <Col lg={2} className="col-6">
                        ...
                        <h5 className="fs-14 mb-0">
                          <span id="invoice-date">
                            {moment(invoice.header.fen_date_create).format("L")}
                          </span>{" "}
                          <small
                      ...
                      <Col lg={2} className="col-6">
                        ...
                        <h5 className="fs-14 mb-0">
                          <span id="invoice-date">
                            {moment(invoice.header.fen_date_expired).format(
                              "L"
                            )}
                          </span>{" "}
                          <small
                        ...
                        {activeChange ? (
                          <select
                            ...
                            onChange={(e) => {
                              ...
                              setSelectedEtat(
                                etat?.find((d) => d.fet_id == e.target.value)
                                  ?.fet_name
                              );
                          ...
                          >
                            {etat.map((e) => {
                              return (
                                <option value={e.fet_id}>{e.fet_name}</option>
                              );
                            })}
                          </select>
                        ) : (
                          ...
                          <thead>
                            <tr className="table-active">
                              ...
                              <th className="text-end">
                                <button
                                  disabled={
                                    invoice?.header.fen_etat == 1 ? true : false
                                  }
