...
const CoverSignUp = () => {
    document.title = "Cover SignUp | Coutanto - React Admin & Dashboard Template";
                                        ...
                                        <Col lg={6}>
                                            <div className="p-lg-5 p-4">
                                                <div>
                                                    ...
                                                    <p className="text-muted">Get your Free Coutanto account now.</p>
                                                </div>
                                                ...
                                                <div className="mt-4">
                                                    <form className="needs-validation" noValidate action="index">
                                                        ...
                                                        <div className="mb-4">
                                                            <p className="mb-0 fs-12 text-muted fst-italic">By registering you agree to the Coutanto <Link to="#" className="text-primary text-decoration-underline fst-normal fw-medium">Terms of Use</Link></p>
                                                        </div>
                                                        ...
                                                        <div className="mt-4 text-center">
                                                            ...
                                                            <div>
                                                                <button type="button" className="btn btn-secondary btn-icon waves-effect waves-light me-1"><i className="ri-facebook-fill fs-16"></i></button>
                                                                ...
                                                                <button type="button" className="btn btn-secondary btn-icon waves-effect waves-light"><i className="ri-twitter-fill fs-16"></i></button>
                                                            </div>
                                                        </div>
                                                    </form>
                                                </div>
                        ...
                        <div className="row">
                            <div className="col-lg-12">
                                <div className="text-center">
                                    <p className="mb-0">&copy; {new Date().getFullYear()} Coutanto. Crafted with <i className="mdi mdi-heart text-danger"></i> by Themesbrand</p>
                                </div>
                            </div>
                        </div>
                    </Container>
