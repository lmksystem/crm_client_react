...
const BasicSignUp = () => {
    document.title = "Basic SignUp | Coutanto - React Admin & Dashboard Template";
                                    ...
                                    <CardBody className="p-4">
                                        ...
                                        <div className="p-2 mt-4">
                                            <form className="needs-validation" action="#">
                                                ...
                                                <div className="mb-4">
                                                    <p className="mb-0 fs-12 text-muted fst-italic">By registering you agree to the Coutanto
                                                ...
                                                <div className="mt-4 text-center">
                                                    ...
                                                    <div>
                                                        <button type="button" className="btn btn-secondary btn-icon waves-effect waves-light"><i className="ri-facebook-fill fs-16"></i></button>{" "}
