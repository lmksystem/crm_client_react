...
//Import actions
import { getTva as onGetTva, addNewTva as onAddNewTva, updateTva as onUpdateTva, deleteTva as onDeleteTva, getConstantes as onGetConstantes, handleConstantes as onHandleConstantes } from "../../slices/thunks";
//redux
                  ...
                  <Col lg={12}>
                    <div>
                      ...
                      <Input
                        ...
                        invalid={validation.touched.tva_libelle && validation.errors.tva_libelle ? true : false}
                      />
                      {validation.touched.tva_libelle && validation.errors.tva_libelle ? <FormFeedback type="invalid">{validation.errors.tva_libelle}</FormFeedback> : null}
                    </div>
                  </Col>
                  <Col lg={12}>
                    <div>
                      ...
                      <Input
                        ...
                        invalid={validation.touched.tva_value && validation.errors.tva_value ? true : false}
                      />
                      {validation.touched.tva_value && validation.errors.tva_value ? <FormFeedback type="invalid">{validation.errors.tva_value}</FormFeedback> : null}
                    </div>
                  </Col>
                </Row>
              </ModalBody>
